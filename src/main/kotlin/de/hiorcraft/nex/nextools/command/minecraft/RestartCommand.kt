...
import de.hiorcraft.nex.nextools.command.argument.durationArgument
import de.hiorcraft.nex.nextools.command.argument.greedyRestartReasonArgument
import de.hiorcraft.nex.nextools.plugin
import de.hiorcraft.nex.nextools.util.userContent
...
fun restartCommand() = commandTree("restart") {
    withPermission(PermissionRegistry.COMMAND_RESTART)
